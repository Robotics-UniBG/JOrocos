...
/**
* RTT/corba/CAnyArgumentsHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from OperationInterface.idl
* Wednesday, July 11, 2012 5:26:49 PM CEST
*/

abstract public class CAnyArgumentsHelper
{
  private static String  _id = "IDL:RTT/corba/CAnyArguments:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (RTT.corba.CAnyArgumentsHelper.id (), "CAnyArguments", __typeCode);
    }
    return __typeCode;
  }
